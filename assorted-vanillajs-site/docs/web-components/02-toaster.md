...
3. Use the `Toaster` class to show toasts

```ts
Toaster.toast("This is a toast message", "info");
Toaster.toast("This is a success message", "success");
Toaster.toast("This is a warning message", "warning");
Toaster.toast("This is a danger message", "danger");
```
